...
public class Tone {
    ...
    public static void main(String[] args) throws Exception {
        String Line;
        Note NoteConversion;
        NoteLength NoteLenConversion;
        
        //need to add try with resource before Lab turn in
        ...
        while ((Line = br.readLine()) != null){
            ...
            System.out.println(noteLen);

            NoteConversion = Enum.valueOf(Note.class, noteSymbol);
            NoteLenConversion = Enum.valueOf(NoteLength.class, noteLen);

            song.add(new BellNote(NoteConversion, NoteLenConversion));
        }
